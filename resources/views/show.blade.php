    ...
    <div class="media border-bottom mt-1">
        <div class="media-body">
            <div class="bg-danger p-3 rounded-top shadow-sm">
                {{ $business->name}}
                <img class="align-self-start float-right mr-3 col-md-2 col-sm-3" src="{{ url($business->logo) }}" alt="logo"/>
            </div>
            ...
            @foreach($businessImages as $businessImage)
                <img class="col-md-3" src="{{$businessImage->logo}}" alt="business image">
                <hr/>
            @endforeach
